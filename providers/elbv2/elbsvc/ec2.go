...
func (svc *ELBService) GetInstancesByID(ids []string) ([]*EC2Instance, error) {
	filters := []*ec2.Filter{
...
func (svc *ELBService) LookupInstancesByIPAddress(ipAddresses []string, privateIP bool) ([]*EC2Instance, error) {
	filters := []*ec2.Filter{
...
func (svc *ELBService) LookupInstancesByFilter(filters []*ec2.Filter) ([]*EC2Instance, error) {
...
func (svc *ELBService) DescribeSubnets(ids []string) ([]*ec2.Subnet, error) {
...
func (svc *ELBService) GetAzSubnets() (map[string]string, error) {
	params := &ec2.DescribeSubnetsInput{
		Filters: []*ec2.Filter{
			{
...
func (svc *ELBService) IsDefaultVPC(vpcID string) (bool, error) {
